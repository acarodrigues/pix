...
public record DadosEnvioPix(ChavePix chavePIX, BigDecimal valor, String cidadeRemetente, String descricao) {
    ...
    public DadosEnvioPix(ChavePix chavePIX, BigDecimal valor, String cidadeRemetente) {
