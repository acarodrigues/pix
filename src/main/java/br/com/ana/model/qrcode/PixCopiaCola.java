package br.com.ana.model.qrcode;
...
public class PixCopiaCola {
    ...
    /**
     * Cria um objeto PixCopiaCola sem um id da transação
     * @param dadosPix Dados preenchidos pelo usuário para envio do PIX
     * @see PixCopiaCola#PixCopiaCola(DadosEnvioPix, String)
     */
    public PixCopiaCola(final DadosEnvioPix dadosPix) {
        this(dadosPix, ID_TRANSACAO_VAZIO);
    }

    /**
     * Cria um objeto PixCopiaCola com um id de transação único.
     * @param dadosPix Dados preenchidos pelo usuário para envio do PIX
     ...
     * @see PixCopiaCola#PixCopiaCola(DadosEnvioPix)
     * @throws IllegalArgumentException quando o ID da transação é inválido
     */
    public PixCopiaCola(final DadosEnvioPix dadosPix, final String idTransacao) {
    ...
    public PixCopiaCola(String idTransacao, DadosEnvioPix dadosPix) {
        this.idTransacao = idTransacao;
        this.dadosPix = dadosPix;
    }
